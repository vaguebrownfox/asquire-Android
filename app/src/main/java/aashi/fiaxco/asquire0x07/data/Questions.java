package aashi.fiaxco.asquire0x07.data;
...
public class Questions {
	...
	public static Question question2 = new Question(2,
			"Do you have repeated episodes of cough?",
			new String[]{"Yes", "No"},
			new int[]{3, 5});


	public static Question question3 = new Question(3,
			"How many times in a year cough-episode occurs?",
			new String[]{"1", "2", "3", ">3"},
			new int[]{4});


	public static Question question4 = new Question(4,
			"How long does each episode last?",
			new String[]{"<3", ">3"},
			new int[]{5});


	public static Question question5 = new Question(5,
			"Are you a known case of Asthma?",
			new String[]{"Yes", "No"},
			new int[]{6, 19});


	public static Question question6 = new Question(6,
	...
	public static Question question8 = new Question(8,
			"Do you experience episodic or continuous wheeze?",
			new String[]{"Episodic", "Continuous", "Can't say"},
			new int[]{9});


	public static Question question9 = new Question(9,
			"Does your wheeze vary with seasons?",
			new String[]{"Yes", "No"},
			new int[]{10});


	public static Question question10 = new Question(10,
			"Does your wheeze vary across the day?",
			new String[]{"Yes", "No"},
			new int[]{11});


	public static Question question11 = new Question(11,
			"Do you have cough?",
			new String[]{"Yes", "No"},
			new int[]{12, 14});
	...
	public static Question question13 = new Question(13,
			"Sputum color",
			new String[]{"White", "Yellow", "Green"},
			new int[]{14});


	public static Question question14 = new Question(14,
			"Are you under any medication for asthma?",
			new String[]{"Yes", "No"},
			new int[]{15});


	public static Question question15 = new Question(15,
			"Do you use inhalers or nebulizers?",
			new String[]{"Inhalers", "Nebulizers", "Both", "Don't use anything"},
			new int[]{16});


	public static Question question16 = new Question(16,
			"Do you have family history of asthma?",
			new String[]{"Yes", "No"},
			new int[]{17});


	public static Question question17 = new Question(17,
			"Do you have allergies?",
			new String[]{"Yes", "No"},
			new int[]{18, 19});


	public static Question question18 = new Question(18,
			"Triggers for allergies?",
			new String[]{"No Triggers", "Pollution", "Strong smells", "Pollen", "Other"},
			new int[]{19});


	public static Question question19 = new Question(19,
			"Have you suffered from lung TB in the past?",
			new String[]{"Yes", "No"},
			new int[]{20});


	public static Question question20 = new Question(20,
			"Do you have any other respiratory illness?",
			new String[]{"Yes", "No"},
			new int[]{21, 22});


	public static Question question21 = new Question(21,
			"Write in brief About it",
			new String[]{},
			new int[]{22});


	public static Question question22 = new Question(22,
			"Are you a known case of high blood pressure?",
			new String[]{"Yes", "No"},
			new int[]{23, 24});


	public static Question question23 = new Question(23,
			"Your high blood pressure is",
			new String[]{"Well controlled", "Nearly controlled"},
			new int[]{24});


	public static Question question24 = new Question(24,
			"Area you a known case of diabetes?",
			new String[]{"Yes", "No"},
			new int[]{25, 26});


	public static Question question25 = new Question(25,
			"Your diabetes is",
			new String[]{"Well controlled", "Nearly controlled"},
			new int[]{26});


	public static Question question26 = new Question(26,
			"Are you a known case of heart disease?",
			new String[]{"Yes", "No"},
			new int[]{27});


	public static Question question27 = new Question(27,
			"Any other health problems?",
			new String[]{"Yes", "No"},
			new int[]{28, -1});


	public static Question question28 = new Question(28,
